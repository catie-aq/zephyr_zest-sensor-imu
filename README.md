...
- the humidity sensor alias: `bme280` to `bme280_zest_sensor_imu_<X>`
- the smart imu alias: `bno055` to `bno055_zest_sensor_imu_<X>`
- the motion sensor alias: `iis2dlpc` to `iis2dlpc_zest_sensor_imu_<X>`
